...
import com.yc.allbluetooth.activity.MainActivity;
...
public class ZhizuCeshiStdLingxianErActivity extends AppCompatActivity implements View.OnClickListener {

    private String TAG = "ZhizuCeshiStdLingxianErActivity";
        ...
        public void handleMessage (Message msg) {
            ...
            switch (msg.what) {
                ...
                case Config.BLUETOOTH_GETDATA:
                    if(StringUtils.isEquals(Config.ymType,"stdLxEr")){
...
//                                        tvStdC0ZsDz.setText(StringUtils.siweiYouxiaoStr(xsys.xiaoshuCheng(kt, xsys.xiaoshu(DianliuDianzuDw.dw("01", c0orca, tvStdC0ZsDzDw))) + ""));
                                    ...
                                    if(Config.fdTcCishu<3){
                                        Config.fdTcCishu+=1;
                                        Toast.makeText(ZhizuCeshiStdLingxianErActivity.this,getString(R.string.fangdiantanchuang),Toast.LENGTH_SHORT).show();
                                    }
...
//                                    TipsDayin.cancel();
                                        ...
                                        Log.e(TAG , "打印");
                                        //TipsDayin.show();
                                        Toast.makeText(ZhizuCeshiStdLingxianErActivity.this,getString(R.string.dayintanchuang),Toast.LENGTH_SHORT).show();
...
//                                    TipsSave = new AlertDialog.Builder(getContext(), R.style.MyDialog).setView(viewSave).create();
                                        ...
                                        Log.e(TAG , "保存1");
                                        //TipsSave.show();
                                        Toast.makeText(ZhizuCeshiStdLingxianErActivity.this,getString(R.string.baocuntanchuang),Toast.LENGTH_SHORT).show();
...
//                                            it.setClass(ZhizuCeshiStdLingxianErActivity.this, StdHomeActivity.class);
...
//                                            startActivity(it);
                                            ...
                                            Config.tiaozhuan = 0;
                                            Config.ymType = "stdLxYi";
                                            Log.e(TAG, "放电111");
                                            Config.lxType = 1;
                                            sendDataByBle(SendUtil.initSendStd("00"),"");//指令随意，为了重新通讯

                                            //startActivity(new Intent(ZhizuCeshiStdLingxianErActivity.this,ZhizuCeshiStdLingxianYiActivity.class));
                                            //finish();
                                            Intent it = new Intent();
                                            it.setClass(ZhizuCeshiStdLingxianErActivity.this, ZhizuCeshiStdLingxianYiActivity.class);
                                            it.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);//销毁前面的页面
                                            it.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);//Main页面不会重新创建
                                            startActivity(it);
                                        }
...
//                                    TipsSave = new AlertDialog.Builder(getContext(), R.style.MyDialog).setView(viewSave).create();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zhizu_ceshi_std_lingxian_er);
        initView();
        Log.e("StdEryemian","进入stdLxEr");
        Config.ymType = "stdLxEr";
    ...
    public void initModel(){
        bleConnectUtil = new BleConnectUtil(ZhizuCeshiStdLingxianErActivity.this);
...
//            finish();
//            startActivity(new Intent(ZhizuCeshiStdLingxianErActivity.this,ZhizuCeshiStdYiActivity.class));
//        }else{
//            Log.e(TAG,"=======");
//            finish();
//        }
