...
public class ZhizuCeshiStdLingxianYiActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String TAG = "ZhizuCeshiStdLingxianYiActivity";
        ...
        public void handleMessage (Message msg) {
            ...
            switch (msg.what) {
                ...
                case Config.BLUETOOTH_GETDATA:
                    if(StringUtils.isEquals(Config.ymType,"stdLxYi")){
                            ...
                            if (newMsgStr.length() == 60) {//> 40
                                ...
                                if(Config.tiaozhuan==0) {
                                    ...
                                    if (StringUtils.isEquals("00", sjxz)) {//0：测试电流；
                                        ...
                                        if(jinruTiaozhuan==0){
                                            jinruTiaozhuan+=1;
//                                            startActivity(new Intent(ZhizuCeshiStdLingxianYiActivity.this, ZhizuCeshiStdLingxianErActivity.class));
//                                            finish();
                                            Log.e(TAG,"===="+ZhizuCeshiStdLingxianErActivity.class);
//                                            if(StringUtils.isEmpty(ZhizuCeshiStdLingxianErActivity.class+"")){
//                                                startActivity(new Intent(ZhizuCeshiStdLingxianYiActivity.this, ZhizuCeshiStdLingxianErActivity.class));
//                                            }else{
                                            finish();
                                                Intent it = new Intent();
                                                it.setClass(ZhizuCeshiStdLingxianYiActivity.this, ZhizuCeshiStdLingxianErActivity.class);
                                        ...
                                        if(Config.fdTcCishu<3){
                                            Config.fdTcCishu+=1;
                                            Toast.makeText(ZhizuCeshiStdLingxianYiActivity.this,getString(R.string.fangdiantanchuang),Toast.LENGTH_SHORT).show();
                                        }
...
//                                            startActivity(new Intent(ZhizuCeshiStdLingxianYiActivity.this, ZhizuCeshiStdLingxianErActivity.class));
//                                            finish();
                                            Log.e(TAG,"====86="+ZhizuCeshiStdLingxianErActivity.class);
//                                            if(StringUtils.isEmpty(ZhizuCeshiStdLingxianErActivity.class+"")){
//                                                startActivity(new Intent(ZhizuCeshiStdLingxianYiActivity.this, ZhizuCeshiStdLingxianErActivity.class));
//                                            }else{
                                            finish();
...
//                                            viewFd = LayoutInflater.from(ZhizuCeshiStdLingxianYiActivity.this).inflate(R.layout.dialog_fangdian, null, false);
//                                            TipsFangdian = new AlertDialog.Builder(ZhizuCeshiStdLingxianYiActivity.this, R.style.MyDialog).setView(viewFd).create();
                                            //TipsFangdian.show();
                                            if(Config.fdTcCishu<3){
                                                Config.fdTcCishu+=1;
                                                Toast.makeText(ZhizuCeshiStdLingxianYiActivity.this,getString(R.string.fangdiantanchuang),Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("yemian","进入stdLxYi");
        resources.updateConfiguration(config, dm);
        setContentView(R.layout.activity_zhizu_ceshi_std_lingxian_yi);
        initView();
    ...
    public void initModel(){
        bleConnectUtil = new BleConnectUtil(ZhizuCeshiStdLingxianYiActivity.this);
    ...
    public void initView(){
        ...
        tvStdB0Dl.setText("");
        tvStdC0Dl.setText("");
        tvStdA0DlDw.setText("A");
        tvStdB0DlDw.setText("A");
        tvStdC0DlDw.setText("A");
