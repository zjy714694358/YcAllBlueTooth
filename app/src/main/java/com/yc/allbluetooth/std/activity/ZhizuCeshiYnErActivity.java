...
public class ZhizuCeshiYnErActivity extends AppCompatActivity implements View.OnClickListener{
    private String TAG = "ZhizuCeshiYnErActivity";

    //YN第二部分
    private LinearLayout llYnCsEr;
    private TextView tvYnCsErXb;
    private TextView tvYnCsErTime;
    private TextView tvYnCsErA0CsDz;
    private TextView tvYnCsErA0CsDzDw;
    private TextView tvYnCsErA0ZsDz;
    private TextView tvYnCsErA0ZsDzDw;
    private TextView tvYnCsErB0CsDz;
    private TextView tvYnCsErB0CsDzDw;
    private TextView tvYnCsErB0ZsDz;
    private TextView tvYnCsErB0ZsDzDw;
    private TextView tvYnCsErC0CsDz;
    private TextView tvYnCsErC0CsDzDw;
    private TextView tvYnCsErC0ZsDz;
    private TextView tvYnCsErC0ZsDzDw;
    private TextView tvYnCsErDzBphl;
    private EditText etYnCsErDzFj;
    private EditText etYnCsErDzSpwd;
    private LinearLayout llYnCsErDzBaocun;
    private LinearLayout llYnCsErDzDayin;
    private LinearLayout llYnCsErDzStop;
        ...
        public void handleMessage (Message msg) {
            ...
            switch (msg.what) {
                ...
                case Config.BLUETOOTH_GETDATA:
                    ...
                    if(StringUtils.isEquals(Config.ymType,"ynEr")){
                        if (msgStr.length() == 22 || msgStr.length() > 28||msgStr.length()==6) {
                            ...
                            if (newMsgStr.length() == 62) {//> 40
                                //可以
                                Log.e("ynErzhizu=60", "new:" + newMsgStr);
                                ...
                                if (StringUtils.isEquals("00", sjxz)) {//0：测试电流；
                                    ...
                                    Log.e(TAG, "====================60==========================电阻==测试相位:" + csxw + "=================================="+Config.ynA0Csdz);
                                ...
                                BigDecimal kt = xsys.xiaoshuChu(xsys.xiaoshuJia(xsys.xiaoshu(Config.rzczInt + ""), xsys.xiaoshu(Config.zswd)),
                                    ...
                                    //0:A0;1:B0;2:C0;3:ab;4:bc;5:ca;6:三相
                                    if(StringUtils.isEquals("00",csxw)){//A0
                                        tvYnCsErXb.setText("A0");
                                        tvYnCsErA0CsDz.setText(DianliuDianzuDw.dw("01", a0orab, tvYnCsErA0CsDzDw));
                                        tvYnCsErA0ZsDz.setText(StringUtils.siweiYouxiaoStr(xsys.xiaoshuCheng(kt, xsys.xiaoshu(DianliuDianzuDw.dw("01", a0orab, tvYnCsErA0ZsDzDw))) + ""));
                                        tvYnCsErB0CsDz.setText(Config.ynB0Csdz);
                                        tvYnCsErB0CsDzDw.setText(Config.ynB0CsdzDw);
                                        tvYnCsErB0ZsDz.setText(StringUtils.siweiYouxiaoStr(xsys.xiaoshuCheng(kt, xsys.xiaoshu(tvYnCsErB0CsDz.getText().toString()))+""));
                                        tvYnCsErB0ZsDzDw.setText(tvYnCsErB0CsDzDw.getText().toString());
                                        tvYnCsErC0CsDz.setText(Config.ynC0Csdz);
                                        tvYnCsErC0CsDzDw.setText(Config.ynC0CsdzDw);
                                        tvYnCsErC0ZsDz.setText(StringUtils.siweiYouxiaoStr(xsys.xiaoshuCheng(kt, xsys.xiaoshu(tvYnCsErC0CsDz.getText().toString()))+""));
                                        tvYnCsErC0ZsDzDw.setText(tvYnCsErC0CsDzDw.getText().toString());
                                    }else if(StringUtils.isEquals("01",csxw)){//B0
                                        tvYnCsErXb.setText("B0");
                                        tvYnCsErB0CsDz.setText(DianliuDianzuDw.dw("01", b0orbc, tvYnCsErB0CsDzDw));
                                        tvYnCsErB0ZsDz.setText(StringUtils.siweiYouxiaoStr(xsys.xiaoshuCheng(kt, xsys.xiaoshu(DianliuDianzuDw.dw("01", b0orbc, tvYnCsErB0ZsDzDw))) + ""));
                                        tvYnCsErA0CsDz.setText(Config.ynA0Csdz);
                                        tvYnCsErA0CsDzDw.setText(Config.ynA0CsdzDw);
                                        tvYnCsErA0ZsDz.setText(StringUtils.siweiYouxiaoStr(xsys.xiaoshuCheng(kt, xsys.xiaoshu(tvYnCsErA0CsDz.getText().toString()))+""));
                                        tvYnCsErA0ZsDzDw.setText(tvYnCsErA0CsDzDw.getText().toString());
                                        tvYnCsErC0CsDz.setText(Config.ynC0Csdz);
                                        tvYnCsErC0CsDzDw.setText(Config.ynC0CsdzDw);
                                        tvYnCsErC0ZsDz.setText(StringUtils.siweiYouxiaoStr(xsys.xiaoshuCheng(kt, xsys.xiaoshu(tvYnCsErC0CsDz.getText().toString()))+""));
                                        tvYnCsErC0ZsDzDw.setText(tvYnCsErC0CsDzDw.getText().toString());
                                    }else if(StringUtils.isEquals("02",csxw)){//C0
                                        tvYnCsErXb.setText("C0");
                                        tvYnCsErC0CsDz.setText(DianliuDianzuDw.dw("01", c0orca, tvYnCsErC0CsDzDw));
                                        tvYnCsErC0ZsDz.setText(StringUtils.siweiYouxiaoStr(xsys.xiaoshuCheng(kt, xsys.xiaoshu(DianliuDianzuDw.dw("01", c0orca, tvYnCsErC0ZsDzDw))) + ""));
                                        tvYnCsErA0CsDz.setText(Config.ynA0Csdz);
                                        tvYnCsErA0CsDzDw.setText(Config.ynA0CsdzDw);
                                        tvYnCsErA0ZsDz.setText(StringUtils.siweiYouxiaoStr(xsys.xiaoshuCheng(kt, xsys.xiaoshu(tvYnCsErA0CsDz.getText().toString()))+""));
                                        tvYnCsErA0ZsDzDw.setText(tvYnCsErA0CsDzDw.getText().toString());
...
//                                    tvYnCsErA0CsDz.setText(Config.ynA0Csdz);
//                                    tvYnCsErA0CsDzDw.setText(Config.ynA0CsdzDw);
//                                    tvYnCsErA0ZsDz.setText(Config.ynA0CsZsdz);
//                                    tvYnCsErA0ZsDzDw.setText(Config.ynA0CsZsdzDw);
//                                    tvYnCsErB0CsDz.setText(Config.ynB0Csdz);
//                                    tvYnCsErB0CsDzDw.setText(Config.ynB0CsdzDw);
//                                    tvYnCsErB0ZsDz.setText(Config.ynB0CsZsdz);
//                                    tvYnCsErB0ZsDzDw.setText(Config.ynB0CsZsdzDw);
//                                    tvYnCsErC0CsDz.setText(Config.ynC0Csdz);
//                                    tvYnCsErC0CsDzDw.setText(Config.ynC0CsdzDw);
//                                    tvYnCsErC0ZsDz.setText(Config.ynC0CsZsdz);
//                                    tvYnCsErC0ZsDzDw.setText(Config.ynC0CsZsdzDw);

                                    tvYnCsErDzBphl.setText(Config.bphl);
                                } else if (StringUtils.isEquals("02", sjxz)) {//放电电流
                                    Log.e(TAG , "电流放电");
                                    //TipsFangdian.show();
                                    if(Config.fdTcCishu<3){
                                            Config.fdTcCishu+=1;
                                            Toast.makeText(ZhizuCeshiYnErActivity.this,getString(R.string.fangdiantanchuang),Toast.LENGTH_SHORT).show();
                                        }
                                    ...
                                    if (StringUtils.isEquals("02", tfxx)) {//正在放电02
                                        ...
                                        Log.e(TAG , "打印");
                                        //TipsDayin.show();
                                            Toast.makeText(ZhizuCeshiYnErActivity.this,getString(R.string.dayintanchuang),Toast.LENGTH_SHORT).show();
                                    } else if (StringUtils.isEquals("11", ShiOrShiliu.parseInt(tfxx).toString())) {//保存成功==>"0B"0F
                                        Log.e(TAG , "保存");
                                        //TipsSave.show();
                                            Toast.makeText(ZhizuCeshiYnErActivity.this,getString(R.string.baocuntanchuang),Toast.LENGTH_SHORT).show();
                                        ...
                                        if (btnType == 1) {//保存
                                            ...
                                            TipsFangdian.cancel();
//                                            startActivity(new Intent(ZhizuCeshiYnErActivity.this,StdHomeActivity.class));
//                                            finish();
                                            Intent it = new Intent();
                                            it.setClass(ZhizuCeshiYnErActivity.this, StdHomeActivity.class);
...
//                                    tvYnCsErC0ZsDzDw.setText(Config.ynC0CsZsdzDw);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zhizu_ceshi_yn_er);
        Config.ymType = "ynEr";
        ActivityCollector.addActivity(this);
        Log.e(TAG,"进入Yn2");

        Config.tiaozhuan = 1;//不再跳转
        Log.e(TAG,Config.yemianType2+"");
    ...
    public void initModel(){
        bleConnectUtil = new BleConnectUtil(ZhizuCeshiYnErActivity.this);
    ...
    public void initView(){
        ...
        //YN(二)
        llYnCsEr = findViewById(R.id.llZhizuCeshiYnEr);
        tvYnCsErXb = findViewById(R.id.tvZzcsYnErCsXb);
        tvYnCsErTime = findViewById(R.id.tvZzcsYnErDzTime);
        tvYnCsErA0CsDz = findViewById(R.id.tvZzcsYnErA0CsDz);
        tvYnCsErA0CsDzDw = findViewById(R.id.tvZzcsYnErA0CsDzDw);
        tvYnCsErA0ZsDz = findViewById(R.id.tvZzcsYnErA0ZsDz);
        tvYnCsErA0ZsDzDw = findViewById(R.id.tvZzcsYnErA0ZsDzDw);
        tvYnCsErB0CsDz = findViewById(R.id.tvZzcsYnErB0CsDz);
        tvYnCsErB0CsDzDw = findViewById(R.id.tvZzcsYnErB0CsDzDw);
        tvYnCsErB0ZsDz = findViewById(R.id.tvZzcsYnErB0ZsDz);
        tvYnCsErB0ZsDzDw = findViewById(R.id.tvZzcsYnErB0ZsDzDw);
        tvYnCsErC0CsDz = findViewById(R.id.tvZzcsYnErC0CsDz);
        tvYnCsErC0CsDzDw = findViewById(R.id.tvZzcsYnErC0CsDzDw);
        tvYnCsErC0ZsDz = findViewById(R.id.tvZzcsYnErC0ZsDz);
        tvYnCsErC0ZsDzDw = findViewById(R.id.tvZzcsYnErC0ZsDzDw);
        tvYnCsErDzBphl = findViewById(R.id.tvZzcsYnErMaxBphl);
        etYnCsErDzFj = findViewById(R.id.etZzcsYnErDzFj);
        etYnCsErDzSpwd = findViewById(R.id.etZzcsYnErDzSpwd);
        llYnCsErDzBaocun = findViewById(R.id.llZzcsYnErCsDzBaocun);
        llYnCsErDzDayin = findViewById(R.id.llZzcsYnErCsDzDayin);
        llYnCsErDzStop = findViewById(R.id.llZzcsYnErCsDzStop);
        EditorAction editorAction = new EditorAction();
        //editorAction.bulingFj(etYnCsErDzFj);
        //editorAction.bulingWdStd(etYnCsErDzSpwd, tvYnCsErA0CsDz, tvYnCsErA0ZsDz, tvYnCsErB0CsDz, tvYnCsErB0ZsDz, tvYnCsErC0CsDz, tvYnCsErC0ZsDz);
        llYnCsErDzBaocun.setOnClickListener(this);
        llYnCsErDzDayin.setOnClickListener(this);
        llYnCsErDzStop.setOnClickListener(this);

        etYnCsErDzFj.setOnEditorActionListener(new TextView.OnEditorActionListener() {//分接位置
            @Override
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                switch (actionId){
                    case EditorInfo.IME_ACTION_DONE:
                        String etStr = etYnCsErDzFj.getText().toString();
                        if(StringUtils.isEquals("00",etStr)){
                            etYnCsErDzFj.setText("00");
                            sendDataByBle(SendUtil.initSendStdNew("77","00"),"");
                        }else if(StringUtils.isEquals("01",etStr)){
                            etYnCsErDzFj.setText("01");
                            sendDataByBle(SendUtil.initSendStdNew("77","01"),"");
                        }else if(StringUtils.isEquals("02",etStr)){
                            etYnCsErDzFj.setText("02");
                            sendDataByBle(SendUtil.initSendStdNew("77","02"),"");
                        }else if(StringUtils.isEquals("03",etStr)){
                            etYnCsErDzFj.setText("03");
                            sendDataByBle(SendUtil.initSendStdNew("77","03"),"");
                        }else if(StringUtils.isEquals("04",etStr)){
                            etYnCsErDzFj.setText("04");
                            sendDataByBle(SendUtil.initSendStdNew("77","04"),"");
                        }else if(StringUtils.isEquals("05",etStr)){
                            etYnCsErDzFj.setText("05");
                            sendDataByBle(SendUtil.initSendStdNew("77","05"),"");
                        }else if(StringUtils.isEquals("06",etStr)){
                            etYnCsErDzFj.setText("06");
                            sendDataByBle(SendUtil.initSendStdNew("77","06"),"");
                        }else if(StringUtils.isEquals("07",etStr)){
                            etYnCsErDzFj.setText("07");
                            sendDataByBle(SendUtil.initSendStdNew("77","07"),"");
                        }else if(StringUtils.isEquals("08",etStr)){
                            etYnCsErDzFj.setText("08");
                            sendDataByBle(SendUtil.initSendStdNew("77","08"),"");
                        }else if(StringUtils.isEquals("09",etStr)){
                            etYnCsErDzFj.setText("09");
                            sendDataByBle(SendUtil.initSendStdNew("77","09"),"");
                        }else if(StringUtils.noEmpty(etStr) && StringUtils.strToInt(etYnCsErDzFj.getText().toString())<10){
                            etYnCsErDzFj.setText("0"+etStr);
                            sendDataByBle(SendUtil.initSendStdNew("77",etYnCsErDzFj.getText().toString()),"");
                        }else if(StringUtils.isEmpty(etStr)){
                            etYnCsErDzFj.setText("02");
                        }else if(StringUtils.strToInt(etYnCsErDzFj.getText().toString())>=10&&StringUtils.strToInt(etYnCsErDzFj.getText().toString())<=15){
                            sendDataByBle(SendUtil.initSendStdNew("77","0"+ ShiOrShiliu.toHexString(StringUtils.strToInt(etYnCsErDzFj.getText().toString()))),"");
                        }else if(StringUtils.strToInt(etYnCsErDzFj.getText().toString())>=16){
                            sendDataByBle(SendUtil.initSendStdNew("77",ShiOrShiliu.toHexString(StringUtils.strToInt(etYnCsErDzFj.getText().toString()))),"");
                        }
                        Config.fjwz = etYnCsErDzFj.getText().toString();
                        break;
                }
                return false;
            }
        ...
        etYnCsErDzSpwd.setOnEditorActionListener(new TextView.OnEditorActionListener() {//试品温度
            @Override
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                switch (actionId){
                    case EditorInfo.IME_ACTION_DONE:
                        String etStr = etYnCsErDzSpwd.getText().toString();
                        if(StringUtils.isEquals("00",etStr)){
                            etYnCsErDzSpwd.setText("00");
                            sendDataByBle(SendUtil.initSendStdNew("74","00"),"");
                        }else if(StringUtils.isEquals("01",etStr)){
                            etYnCsErDzSpwd.setText("01");
                            sendDataByBle(SendUtil.initSendStdNew("74","01"),"");
                        }else if(StringUtils.isEquals("02",etStr)){
                            etYnCsErDzSpwd.setText("02");
                            sendDataByBle(SendUtil.initSendStdNew("74","02"),"");
                        }else if(StringUtils.isEquals("03",etStr)){
                            etYnCsErDzSpwd.setText("03");
                            sendDataByBle(SendUtil.initSendStdNew("74","03"),"");
                        }else if(StringUtils.isEquals("04",etStr)){
                            etYnCsErDzSpwd.setText("04");
                            sendDataByBle(SendUtil.initSendStdNew("74","04"),"");
                        }else if(StringUtils.isEquals("05",etStr)){
                            etYnCsErDzSpwd.setText("05");
                            sendDataByBle(SendUtil.initSendStdNew("74","05"),"");
                        }else if(StringUtils.isEquals("06",etStr)){
                            etYnCsErDzSpwd.setText("06");
                            sendDataByBle(SendUtil.initSendStdNew("74","06"),"");
                        }else if(StringUtils.isEquals("07",etStr)){
                            etYnCsErDzSpwd.setText("07");
                            sendDataByBle(SendUtil.initSendStdNew("74","07"),"");
                        }else if(StringUtils.isEquals("08",etStr)){
                            etYnCsErDzSpwd.setText("08");
                            sendDataByBle(SendUtil.initSendStdNew("74","08"),"");
                        }else if(StringUtils.isEquals("09",etStr)){
                            etYnCsErDzSpwd.setText("09");
                            sendDataByBle(SendUtil.initSendStdNew("74","09"),"");
                        }else if(StringUtils.noEmpty(etStr) && StringUtils.strToInt(etYnCsErDzSpwd.getText().toString())<10){
                            etYnCsErDzSpwd.setText("0"+etStr);
                            sendDataByBle(SendUtil.initSendStdNew("74",etYnCsErDzSpwd.getText().toString()),"");
                        }else if(StringUtils.isEmpty(etStr)){
                            etYnCsErDzSpwd.setText("20");
                            sendDataByBle(SendUtil.initSendStdNew("74","14"),"");
                        }else if(StringUtils.strToInt(etYnCsErDzSpwd.getText().toString())>=10&&StringUtils.strToInt(etYnCsErDzSpwd.getText().toString())<=15){
                            sendDataByBle(SendUtil.initSendStdNew("74","0"+ ShiOrShiliu.toHexString(StringUtils.strToInt(etYnCsErDzSpwd.getText().toString()))),"");
                        }else if(StringUtils.strToInt(etYnCsErDzSpwd.getText().toString())>=16){
                            sendDataByBle(SendUtil.initSendStdNew("74",ShiOrShiliu.toHexString(StringUtils.strToInt(etYnCsErDzSpwd.getText().toString()))),"");
                        }

                        Config.cswd = etYnCsErDzSpwd.getText().toString();

                        String a0CsDzStr = tvYnCsErA0CsDz.getText().toString();
                        String b0CsDzStr = tvYnCsErB0CsDz.getText().toString();
                        String c0CsDzStr = tvYnCsErC0CsDz.getText().toString();
                        XiaoshuYunsuan xsys = new XiaoshuYunsuan();
                        BigDecimal kt = xsys.xiaoshuChu(xsys.xiaoshuJia(xsys.xiaoshu(Config.rzczInt + ""), xsys.xiaoshu(Config.zswd)),
                                xsys.xiaoshuJia(xsys.xiaoshu(Config.rzczInt + ""), xsys.xiaoshu(Config.cswd)));//少测试温度
                        tvYnCsErA0ZsDz.setText(StringUtils.siweiYouxiaoStr(xsys.xiaoshuCheng(kt, xsys.xiaoshu(a0CsDzStr))+""));
                        tvYnCsErB0ZsDz.setText(StringUtils.siweiYouxiaoStr(xsys.xiaoshuCheng(kt, xsys.xiaoshu(b0CsDzStr))+""));
                        tvYnCsErC0ZsDz.setText(StringUtils.siweiYouxiaoStr(xsys.xiaoshuCheng(kt, xsys.xiaoshu(c0CsDzStr))+""));
                        break;
                }
                return false;
            }
...
//        tvYnCsErDzBphl.setText(Config.bphl);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.llZzcsYnErCsDzBaocun:
                btnType = 1;
                sendDataByBle(SendUtil.initSendStd("6d"), "");
                break;
            case R.id.llZzcsYnErCsDzDayin:
                btnType = 2;
                sendDataByBle(SendUtil.initSendStd("6c"), "");
                break;
            case R.id.llZzcsYnErCsDzStop:
                btnType = 3;
                Config.fdTcCishu = 0;
