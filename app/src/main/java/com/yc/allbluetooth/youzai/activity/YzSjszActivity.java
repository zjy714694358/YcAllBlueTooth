...
public class YzSjszActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText etBjdz;
    private TextView tvBcxg;
    private TextView tvFh;
    private String TAG = "YzSjszActivity";
        ...
        public void handleMessage (Message msg) {
            ...
            switch (msg.what) {
                ...
                case Config.BLUETOOTH_GETDATA:
                    if(StringUtils.isEquals(Config.ymType,"yzSjsz")){
                        String msgStr = msg.obj.toString();
                        Log.e(TAG, "Sjsz:"+msgStr);
                    }
                    break;
                default:
                    break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yz_sjsz);
        Config.ymType = "yzSjsz";
    ...
    public void initModel(){
        bleConnectUtil = new BleConnectUtil(YzSjszActivity.this);
    ...
    public void initView(){
        etNian = findViewById(R.id.etYzSjszNian);
        etYue = findViewById(R.id.etYzSjszYue);
        etRi = findViewById(R.id.etYzSjszRi);
        etShi = findViewById(R.id.etYzSjszShi);
        etFen = findViewById(R.id.etYzSjszFen);
        etMiao = findViewById(R.id.etYzSjszMiao);
        etBjdz = findViewById(R.id.etYzSjszBjdz);
        tvBcxg = findViewById(R.id.tvYzSjszBcxg);
        tvFh = findViewById(R.id.tvYzSjszFh);
        tvBcxg.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.tvYzSjszBcxg:
                //0xfe  0xef  0x04  0xB0  0x07  0x00  日期和时间 0xfd  0xdf
                ...
                Log.e(TAG,nianStr);
                int nianInt = StringUtils.strToInt(nianStr);
                int yueInt = StringUtils.strToInt(yueStr);
                int riInt = StringUtils.strToInt(riStr);
                int shiInt = StringUtils.strToInt(shiStr);
                int fenInt = StringUtils.strToInt(fenStr);
                int miaoInt = StringUtils.strToInt(miaoStr);
                Log.e(TAG,nianInt+"");
                ...
                //sendDataByBle(CrcAll.crcAdd("feef"+Config.yzBenjiAddress+"B00700"+nianHex+yueHex+riHex+"00"+"11"+fenHex+miaoHex+"fddf",Config.yzCrcTYpe),"");
                break;
            case R.id.tvYzSjszFh:
                //sendDataByBle("feef04e00000fddf","");
                finish();
                break;
        }
    }
