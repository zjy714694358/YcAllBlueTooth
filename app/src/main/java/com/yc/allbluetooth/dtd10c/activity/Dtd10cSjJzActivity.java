...
public class Dtd10cSjJzActivity extends AppCompatActivity {
    ...
    private String TAG = "SjJzActivity";
...
//            language.translateText(SjJzActivity.this,"",1);
//        }else{
//            language.translateText(SjJzActivity.this,"",2);
//        }
        ...
        setContentView(R.layout.activity_dtd10c_sj_jz);
        Config.ymType = "dtdSjJz";
    ...
    public void initView(){
        btnQr = findViewById(R.id.btnSjJzQueren);
        etNian = findViewById(R.id.etSjJzNian);
        etYue = findViewById(R.id.etSjJzYue);
        etRi = findViewById(R.id.etSjJzRi);
        etShi = findViewById(R.id.etSjJzShi);
        etFen = findViewById(R.id.etSjJzFen);
        etMiao = findViewById(R.id.etSjJzMiao);
        tvBack = findViewById(R.id.tvSjJzBack);
        btnQr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendDataByBle(SendUtil.shijianSend("6d",nianStr+yueStr+riStr+shiStr+fenStr+miaoStr),"");
            }
        });
    ...
    public void initModel(){
        bleConnectUtil = new BleConnectUtil(Dtd10cSjJzActivity.this);
