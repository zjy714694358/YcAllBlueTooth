...
public class Dtd10cHomeActivity extends AppCompatActivity implements View.OnClickListener {

    private LinearLayout llZzCs;
    private LinearLayout llJlCx;
...
//                    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Config.CN_US_TYPE==2){
            language.translateText(HomeActivity.this,"",1);
        }else{
            language.translateText(HomeActivity.this,"",2);
        }*/
        ...
        setContentView(R.layout.activity_dtd10c_home);
        Config.ymType = "dtdHome";
    ...
    public void initView(){
        llZzCs = findViewById(R.id.llHomeZzCs);
        llJlCx = findViewById(R.id.llHomeJlCx);
        llSjJz = findViewById(R.id.llHomeSjJz);
        llXtSz = findViewById(R.id.llHomeXtSz);
        tvTime = findViewById(R.id.tvHomeTime);
        tvBack = findViewById(R.id.tvHomeBack);
        llZzCs.setOnClickListener(this);
        llJlCx.setOnClickListener(this);
    ...
    public void initModel(){
        bleConnectUtil = new BleConnectUtil(Dtd10cHomeActivity.this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.llHomeZzCs:
                sendDataByBle(SendUtil.initSend("6a"),"");
//                bleConnectUtil.disConnect();
//                mHandler.removeCallbacksAndMessages(null);
                startActivity(new Intent(Dtd10cHomeActivity.this,Dtd10cZzCs1Activity.class));
                break;
            case R.id.llHomeJlCx:
                startActivity(new Intent(Dtd10cHomeActivity.this,Dtd10cJlCxActivity.class));
                break;
            case R.id.llHomeSjJz:
                startActivity(new Intent(Dtd10cHomeActivity.this,Dtd10cSjJzActivity.class));
                break;
            case R.id.llHomeXtSz:
                startActivity(new Intent(Dtd10cHomeActivity.this,Dtd10cXtSzActivity.class));
                break;
            case R.id.tvHomeBack:
//                bleConnectUtil.disConnect();
//                mHandler.removeCallbacksAndMessages(null);
                finish();
                break;
