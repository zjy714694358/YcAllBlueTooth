...
public class Dtd10cXtSzActivity extends AppCompatActivity {

    private String TAG = "XtSzActivity";
...
//            language.translateText(XtSzActivity.this,"",1);
//        }else{
//            language.translateText(XtSzActivity.this,"",2);
//        }
        ...
        setContentView(R.layout.activity_dtd10c_xt_sz);
        Config.ymType = "dtdXtSz";
    ...
    public void initView(){
        tvBack = findViewById(R.id.tvXtSzYqSzBack);
        etSpBh = findViewById(R.id.etXtSzYqSzSpBh);
...
//                        if(spbh.length()<2||spbh.length()>8){
//                            Toast.makeText(Dtd10cXtSzActivity.this,"请输入2到8位数之间",Toast.LENGTH_SHORT).show();
//                        }else{
//                            Log.e(TAG,spbh);
//                            sendDataByBle(SendUtil.yiqibianhaoSend("6c", BytesToHexString.str2HexStr(spbh)),"");
//                        }
                        sendDataByBle(SendUtil.yiqibianhaoSend("6c", spbh),"");
                        break;
                }
                return false;
            }
    ...
    public void initModel(){
        bleConnectUtil = new BleConnectUtil(Dtd10cXtSzActivity.this);
