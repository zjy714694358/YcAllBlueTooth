...
public class DlzkDanxiangYiActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        public void handleMessage (Message msg) {
            ...
            switch (msg.what) {
                ...
                case Config.BLUETOOTH_GETDATA:
                    ...
                    if(StringUtils.isEquals(Config.ymType,"dlzkDxYi")){
                        //Log.e(TAG,msgStr);
                        if(IndexOfAndSubStr.isIndexOf(msgStr,"66")|| IndexOfAndSubStr.isIndexOf(msgStr,"6677")){
                            ...
                            if(diyi==0){
                                if(IndexOfAndSubStr.isIndexOf(newMsgStr2,"667770")){
                                    ...
                                    sendDataByBle(SendUtil.dlzkCanshuShuruDanzijieSend("69", "03"),"");
                                }else if(IndexOfAndSubStr.isIndexOf(newMsgStr2,"667769")){
                                    ...
                                    sendDataByBle(SendUtil.dlzkCanshuShuruDanzijieSend("68","00"),"");
                                }else if(IndexOfAndSubStr.isIndexOf(newMsgStr2,"667768")){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dlzk_danxiang_yi);
        Config.ymType = "dlzkDxYi";
    ...
    public void initModel(){
        bleConnectUtil = new BleConnectUtil(DlzkDanxiangYiActivity.this);
...
//        sendDataByBle(SendUtil.dlzkCanshuShuruLiuzijieSend("7d", ""), "");
    ...
    public void initView(){
        ...
        tvTime = findViewById(R.id.tvDlzkDanxiangYiTime);
        etEdrl = findViewById(R.id.etDlzkDanxiangYiEdrl);
        tvXzdy = findViewById(R.id.tvDlzkDanxiangYiXzdy);
        etFjdy = findViewById(R.id.etDlzkDanxiangYiFjdy);
        etSpdl = findViewById(R.id.etDlzkDanxiangYiSpdl);
        etMpzk = findViewById(R.id.etDlzkDanxiangYiMpzk);
        etClwd = findViewById(R.id.etDlzkDanxiangYiClwd);
        etFjwz = findViewById(R.id.etDlzkDanxiangYiFjwz);
        etJzwd = findViewById(R.id.etDlzkDanxiangYiJzwd);
        tvClwz = findViewById(R.id.tvDlzkDanxiangYiClwz);
        tvByqlx = findViewById(R.id.tvDlzkDanxiangYiByqlx);
        etSpbh = findViewById(R.id.etDlzkDanxiangYiSpbh);
        etCsry = findViewById(R.id.etDlzkDanxiangYiCsry);
        tvClxb = findViewById(R.id.tvDlzkDanxiangYiClxb);

        llXzdy = findViewById(R.id.llDlzkDanxiangYiXzdy);
        llClwz = findViewById(R.id.llDlzkDanxiangYiClwz);
        llByqlx = findViewById(R.id.llDlzkDanxiangYiByqlx);
        llClxb = findViewById(R.id.llDlzkDanxiangYiClxb);
        llCeshi = findViewById(R.id.llDlzkDanxiangYiCeshi);
        llFanhui = findViewById(R.id.llDlzkDanxiangYiFanhui);
        llXzdy.setOnClickListener(this);
        llClwz.setOnClickListener(this);
        llByqlx.setOnClickListener(this);
        llClxb.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.llDlzkDanxiangYiXzdy://选择电源
                diyi = 1;
                ...
                break;
            case R.id.llDlzkDanxiangYiClwz://测量位置
                diyi = 1;
                ...
                break;
            case R.id.llDlzkDanxiangYiByqlx://变压器类型
                diyi = 1;
                String byqlxStr = tvByqlx.getText().toString();
                //如果是单相，测量相别改为A0
                sendDataByBle(SendUtil.dlzkCanshuShuruDanzijieSend("69",DlzkQiehuan.byqlx(byqlxStr,tvByqlx,tvClxb)),"");
                break;
            case R.id.llDlzkDanxiangYiClxb://测量相别
                diyi = 1;
                String clxbStr = tvClxb.getText().toString();
                String byqlxStr2 = tvByqlx.getText().toString();
                if(StringUtils.isEquals(byqlxStr2,"单相")||StringUtils.isEquals(byqlxStr2,"Single-phase")){//如果是单相中、英文无操作
                    //无操作
                }else{
                    //如果是三相
                    sendDataByBle(SendUtil.dlzkCanshuShuruDanzijieSend("68",DlzkQiehuan.clxb(clxbStr,tvClxb)),"");
                }

                break;
            case R.id.llDlzkDanxiangYiCeshi://测试
                diyi = 1;
                Config.mpzkDx = etMpzk.getText().toString();
                sendDataByBle(SendUtil.startCsSend("7c", "00"), "");
                //finish();
                startActivity(new Intent(DlzkDanxiangYiActivity.this,DlzkDanxiangErActivity.class));
                break;
            case R.id.llDlzkDanxiangYiFanhui://返回
                diyi = 1;
