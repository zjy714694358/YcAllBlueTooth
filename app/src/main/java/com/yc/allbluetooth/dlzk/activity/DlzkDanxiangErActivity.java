...
public class DlzkDanxiangErActivity extends AppCompatActivity implements View.OnClickListener{
        ...
        public void handleMessage (Message msg) {
            ...
            switch (msg.what) {
                ...
                case Config.BLUETOOTH_GETDATA:
                    ...
                    if(StringUtils.isEquals(Config.ymType,"dlzkDxEr")){
                        Log.e(TAG,msgStr);
                        //jinruI=jinruI+1;
                        //if(jinruI%2==0) {
                        ...
                        if(newMsgStr.length()==16){
                            ...
                            if(CrcUtil.CrcIsOk(bytesSx,crcJy)){
                                ...
                                if(StringUtils.isEquals("06",sjxz)){
                                    ...
                                    if(StringUtils.isEquals("02",tfxx)){
                                        Log.e(TAG,"保存");
                                        //TipsSave.show();
                                        Toast.makeText(DlzkDanxiangErActivity.this,getString(R.string.baocuntanchuang),Toast.LENGTH_SHORT).show();
                                    }else if(StringUtils.isEquals("07",tfxx)){
                                        Log.e(TAG,"打印");
                                        //TipsDayin.show();
                                        Toast.makeText(DlzkDanxiangErActivity.this,getString(R.string.dayintanchuang),Toast.LENGTH_SHORT).show();
                            ...
                            if(CrcUtil.CrcIsOk(bytesSx,crcJy)){
                                ...
                                Log.e("次数====",zhilingCishu+"");//16次锁屏，重测加10次===26次
                                ...
                                if(StringUtils.isEquals("00",sjxz)){
                                    Config.sjdyA0 = dy2;
                                    Config.sjdlA0 = dl2;
                                    Config.clzkA0 = zk2;
                                    Config.cldkA0 = gk2;
                                    ...
                                    Log.e("电感===a0",dg2);
                                    Config.zkdyA0 = zkdy2;
                                }else if(StringUtils.isEquals("01",sjxz)){
                                    Config.sjdyB0 = dy2;
                                    Config.sjdlB0 = dl2;
                                    Config.clzkB0 = zk2;
                                    Config.cldkB0 = gk2;
                                    ...
                                    Log.e("电感===b0",dg2);
                                    Config.zkdyB0 = zkdy2;
                                }else if(StringUtils.isEquals("02",sjxz)){
                                    Config.sjdyC0 = dy2;
                                    Config.sjdlC0 = dl2;
                                    Config.clzkC0 = zk2;
                                    Config.cldkC0 = gk2;
                            ...
                            if(CrcUtil.CrcIsOk(bytesSx,crcJy)){
                                ...
                                if(StringUtils.isEquals(sjxz,"55")){
                                    ...
                                    Config.allDxZkdyBfs = StringUtils.gaodiHuanBaoliuWuwei(allZkdyBfs);
                                    Config.allDxZkdyBfs2 = StringUtils.gaodiHuanBaoliuShierwei(allZkdyBfs);
                                    Config.ldgA0 = StringUtils.gaodiHuanBaoliuShierwei(allDgAB);
                                    Config.ldgB0 = StringUtils.gaodiHuanBaoliuShierwei(allDgBc);
                                    Config.ldgC0 = StringUtils.gaodiHuanBaoliuShierwei(allDgCa);
                                    XiaoshuYunsuan xiaoshuYunsuan = new XiaoshuYunsuan();
                                    double bdGkAbCheng = xiaoshuYunsuan.xiaoshuCheng(xiaoshuYunsuan.xiaoshu(Config.ldgA0),xiaoshuYunsuan.xiaoshu("314.15926"));
                                    Config.cldkA0 = StringUtils.shierweiYouxiaoStr(xiaoshuYunsuan.xiaoshuChu(xiaoshuYunsuan.xiaoshu(bdGkAbCheng+""),xiaoshuYunsuan.xiaoshu("1000"))+"");
                                    double bdGkBcCheng = xiaoshuYunsuan.xiaoshuCheng(xiaoshuYunsuan.xiaoshu(Config.ldgB0),xiaoshuYunsuan.xiaoshu("314.15926"));
                                    Config.cldkB0 = StringUtils.shierweiYouxiaoStr(xiaoshuYunsuan.xiaoshuChu(xiaoshuYunsuan.xiaoshu(bdGkBcCheng+""),xiaoshuYunsuan.xiaoshu("1000"))+"");
                                    double bdGkCaCheng = xiaoshuYunsuan.xiaoshuCheng(xiaoshuYunsuan.xiaoshu(Config.ldgC0),xiaoshuYunsuan.xiaoshu("314.15926"));
                                    Config.cldkC0 = StringUtils.shierweiYouxiaoStr(xiaoshuYunsuan.xiaoshuChu(xiaoshuYunsuan.xiaoshu(bdGkCaCheng+""),xiaoshuYunsuan.xiaoshu("1000"))+"");
                                    Log.e("dxEr===","跳转");
                                    finish();
                                    startActivity(new Intent(DlzkDanxiangErActivity.this,DlzkDanxiangSanActivity.class));
                                }
                            }
                        }
                    }
                ...
                case 1000:
                    ...
                    Toast.makeText(DlzkDanxiangErActivity.this, "超时请重试!", Toast.LENGTH_SHORT).show();
                    break;
                case 1111:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dlzk_danxiang_er);
        Config.ymType = "dlzkDxEr";
    ...
    public void initModel(){
        bleConnectUtil = new BleConnectUtil(DlzkDanxiangErActivity.this);
    ...
    public void initView(){
        tvTime = findViewById(R.id.tvDlzkDanxiangErTime);
        tvU = findViewById(R.id.tvDlzkDanxiangErU);
        tvI = findViewById(R.id.tvDlzkDanxiangErI);
        tvFrq = findViewById(R.id.tvDlzkDanxiangErFrq);
        tvXiangweijiao = findViewById(R.id.tvDlzkDanxiangErXiangweijiao);
        tvP = findViewById(R.id.tvDlzkDanxiangErP);
        tvCos = findViewById(R.id.tvDlzkDanxiangErCos);
        tvZk = findViewById(R.id.tvDlzkDanxiangErZk);
        tvXk = findViewById(R.id.tvDlzkDanxiangErXk);
        tvRk = findViewById(R.id.tvDlzkDanxiangErRk);
        tvLk = findViewById(R.id.tvDlzkDanxiangErLk);
        tvZkBfh = findViewById(R.id.tvDlzkDanxiangErZkBaifenhao);
        tvDZkBfh = findViewById(R.id.tvDlzkDanxiangErDZkBaifenhao);

        tvSuoping = findViewById(R.id.tvDlzkDanxiangErSuoping);
        tvBaocun = findViewById(R.id.tvDlzkDanxiangErBaocun);
        tvChongce = findViewById(R.id.tvDlzkDanxiangErChongce);
        tvDayin = findViewById(R.id.tvDlzkDanxiangErDayin);
        tvFanhui = findViewById(R.id.tvDlzkDanxiangErFanhui);
