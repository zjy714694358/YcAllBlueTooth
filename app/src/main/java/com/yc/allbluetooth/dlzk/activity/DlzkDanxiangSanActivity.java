...
public class DlzkDanxiangSanActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String TAG = "DlzkDxSanActivity";
        ...
        public void handleMessage (Message msg) {
            ...
            switch (msg.what) {
                ...
                case Config.BLUETOOTH_GETDATA:
                    ...
                    if(StringUtils.isEquals(Config.ymType,"dlzkDxSan")){
                        Log.e(TAG,msgStr);
                            ...
                            if(CrcUtil.CrcIsOk(bytesSx,crcJy)){
                                ...
                                if(StringUtils.isEquals("06",sjxz)){
                                    ...
                                    if(StringUtils.isEquals("02",tfxx)){
                                        Log.e(TAG,"保存");
                                        //TipsSave.show();
                                        Toast.makeText(DlzkDanxiangSanActivity.this,getString(R.string.baocuntanchuang),Toast.LENGTH_SHORT).show();
                                    }else if(StringUtils.isEquals("07",tfxx)){
                                        Log.e(TAG,"打印");
                                        //TipsDayin.show();
                                        Toast.makeText(DlzkDanxiangSanActivity.this,getString(R.string.dayintanchuang),Toast.LENGTH_SHORT).show();
...
//                        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dlzk_danxiang_san);
        Config.ymType = "dlzkDxSan";
        Log.e("dxsan===","进入...");
    ...
    public void initModel(){
        bleConnectUtil = new BleConnectUtil(DlzkDanxiangSanActivity.this);
    ...
    public void initView(){
        tvTime = findViewById(R.id.tvDlzkDanxiangSanTime);
        tvSjdyAb = findViewById(R.id.tvDlzkDanxiangSanShijiadianyaAb);
        tvSjdyBc = findViewById(R.id.tvDlzkDanxiangSanShijiadianyaBc);
        tvSjdyCa = findViewById(R.id.tvDlzkDanxiangSanShijiadianyaCa);
        tvSjdlAb = findViewById(R.id.tvDlzkDanxiangSanShijiadianliuAb);
        tvSjdlBc = findViewById(R.id.tvDlzkDanxiangSanShijiadianliuBc);
        tvSjdlCa = findViewById(R.id.tvDlzkDanxiangSanShijiadianliuCa);
        tvClxjAb = findViewById(R.id.tvDlzkDanxiangSanCeliangxiangjiaoAb);
        tvClxjBc = findViewById(R.id.tvDlzkDanxiangSanCeliangxiangjiaoBc);
        tvClxjCa = findViewById(R.id.tvDlzkDanxiangSanCeliangxiangjiaoCa);
        tvYgglAb = findViewById(R.id.tvDlzkDanxiangSanYougonggonglvAb);
        tvYgglBc = findViewById(R.id.tvDlzkDanxiangSanYougonggonglvBc);
        tvYgglCa = findViewById(R.id.tvDlzkDanxiangSanYougonggonglvCa);
        tvDlzkAb = findViewById(R.id.tvDlzkDanxiangSanDuanluzukangAb);
        tvDlzkBc = findViewById(R.id.tvDlzkDanxiangSanDuanluzukangBc);
        tvDlzkCa = findViewById(R.id.tvDlzkDanxiangSanDuanluzukangCa);
        tvDlgkAb = findViewById(R.id.tvDlzkDanxiangSanDuanlugankangAb);
        tvDlgkBc = findViewById(R.id.tvDlzkDanxiangSanDuanlugankangBc);
        tvDlgkCa = findViewById(R.id.tvDlzkDanxiangSanDuanlugankangCa);
        tvRzdgAb = findViewById(R.id.tvDlzkDanxiangSanRaozudianganAb);
        tvRzdgBc = findViewById(R.id.tvDlzkDanxiangSanRaozudianganBc);
        tvRzdgCa = findViewById(R.id.tvDlzkDanxiangSanRaozudianganCa);
        tvZkdyAb = findViewById(R.id.tvDlzkDanxiangSanZukangdianyaAb);
        tvZkdyBc = findViewById(R.id.tvDlzkDanxiangSanZukangdianyaBc);
        tvZkdyCa = findViewById(R.id.tvDlzkDanxiangSanZukangdianyaCa);
        tvZkdyZk = findViewById(R.id.tvDlzkDanxiangSanZukangdianyaZk);
        tvZkwcDzk = findViewById(R.id.tvDlzkDanxiangSanZukangwuchaDZk);
        tvBaocun = findViewById(R.id.tvDlzkDanxiangSanBaocun);
        tvDayin = findViewById(R.id.tvDlzkDanxiangSanDayin);
        tvFanhui = findViewById(R.id.tvDlzkDanxiangSanFanhui);

        tvHxpcClzk = findViewById(R.id.tvDlzkDanxiangSanHxpcClzk);
        tvHxpcCldk = findViewById(R.id.tvDlzkDanxiangSanHxpcCldk);
        tvHxpcLdg = findViewById(R.id.tvDlzkDanxiangSanHxpcLdg);
        tvHxpcZkdy = findViewById(R.id.tvDlzkDanxiangSanHxpcZkdy);
        ...
        tvSjdyAb.setText(StringUtils.wuweiYouxiaoStr(Config.sjdyA0));
        tvSjdlAb.setText(StringUtils.wuweiYouxiaoStr(Config.sjdlA0));
        tvDlzkAb.setText(StringUtils.wuweiYouxiaoStr(Config.clzkA0));
        tvDlgkAb.setText(StringUtils.wuweiYouxiaoStr(Config.cldkA0));
        tvRzdgAb.setText(StringUtils.wuweiYouxiaoStr(Config.ldgA0));
        tvZkdyAb.setText(StringUtils.wuweiYouxiaoStr(Config.zkdyA0));

        tvSjdyBc.setText(StringUtils.wuweiYouxiaoStr(Config.sjdyB0));
        tvSjdlBc.setText(StringUtils.wuweiYouxiaoStr(Config.sjdlB0));
        tvDlzkBc.setText(StringUtils.wuweiYouxiaoStr(Config.clzkB0));
        tvDlgkBc.setText(StringUtils.wuweiYouxiaoStr(Config.cldkB0));
        tvRzdgBc.setText(StringUtils.wuweiYouxiaoStr(Config.ldgB0));
        tvZkdyBc.setText(StringUtils.wuweiYouxiaoStr(Config.zkdyB0));

        tvSjdyCa.setText(StringUtils.wuweiYouxiaoStr(Config.sjdyC0));
        tvSjdlCa.setText(StringUtils.wuweiYouxiaoStr(Config.sjdlC0));
        tvDlzkCa.setText(StringUtils.wuweiYouxiaoStr(Config.clzkC0));
        tvDlgkCa.setText(StringUtils.wuweiYouxiaoStr(Config.cldkC0));
        tvRzdgCa.setText(StringUtils.wuweiYouxiaoStr(Config.ldgC0));
        tvZkdyCa.setText(StringUtils.wuweiYouxiaoStr(Config.zkdyC0));
...
//                xiaoshuYunsuan.xiaoshu(Config.zkdyBc)),xiaoshuYunsuan.xiaoshu(Config.zkdyCa)),xiaoshuYunsuan.xiaoshu("3")) + "");
        tvZkdyZk.setText(Config.allDxZkdyBfs);//阻抗电压Zk%
        if(StringUtils.noEmpty(Config.mpzkDx)){//阻抗误差DZk%
            tvZkwcDzk.setText(StringUtils.wuweiYouxiaoStr(xiaoshuYunsuan.xiaoshuCheng(xiaoshuYunsuan.xiaoshuChu6(xiaoshuYunsuan.xiaoshuJian(xiaoshuYunsuan.xiaoshu(Config.allDxZkdyBfs2),xiaoshuYunsuan.xiaoshu(Config.mpzkDx)),xiaoshuYunsuan.xiaoshu(Config.mpzkDx)),xiaoshuYunsuan.xiaoshu("100"))+""));
        }
        //测量阻抗(短路阻抗)
        Log.e("dx====clzkA0",Config.clzkA0);
        Log.e("dx====clzkB0",Config.clzkB0);
        Log.e("dx====clzkC0",Config.clzkC0);
        BigDecimal bdClzkAb = xiaoshuYunsuan.xiaoshu(Config.clzkA0);
        BigDecimal bdClzkBc = xiaoshuYunsuan.xiaoshu(Config.clzkB0);
        BigDecimal bdClzkCa = xiaoshuYunsuan.xiaoshu(Config.clzkC0);
        ...
        //测量电抗(短路感抗)
        BigDecimal bdCldkAb = xiaoshuYunsuan.xiaoshu(Config.cldkA0);
        BigDecimal bdCldkBc = xiaoshuYunsuan.xiaoshu(Config.cldkB0);
        BigDecimal bdCldkCa = xiaoshuYunsuan.xiaoshu(Config.cldkC0);
        ...
        //漏电感(绕组电感)
        BigDecimal bdLdgAb = xiaoshuYunsuan.xiaoshu(Config.ldgA0);
        BigDecimal bdLdgBc = xiaoshuYunsuan.xiaoshu(Config.ldgB0);
        BigDecimal bdLdgCa = xiaoshuYunsuan.xiaoshu(Config.ldgC0);
        ...
        //阻抗电压(阻抗电压)
        BigDecimal bdZkdyAb = xiaoshuYunsuan.xiaoshu(Config.zkdyA0);
        BigDecimal bdZkdyBc = xiaoshuYunsuan.xiaoshu(Config.zkdyB0);
        BigDecimal bdZkdyCa = xiaoshuYunsuan.xiaoshu(Config.zkdyC0);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.tvDlzkDanxiangSanBaocun:
                btnType = 1;
                sendDataByBle(SendUtil.initSend("85"),"");
                Toast.makeText(DlzkDanxiangSanActivity.this,getString(R.string.baocuntanchuang),Toast.LENGTH_SHORT).show();
                break;
            case R.id.tvDlzkDanxiangSanDayin:
                btnType = 2;
                sendDataByBle(SendUtil.initSend("86"),"");
                Toast.makeText(DlzkDanxiangSanActivity.this,getString(R.string.dayintanchuang),Toast.LENGTH_SHORT).show();
                break;
            case R.id.tvDlzkDanxiangSanFanhui://返回（停止88）
